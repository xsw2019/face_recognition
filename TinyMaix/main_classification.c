...
#include "model-53451-final.h"                         // model header file generted by maixhub
...
#define PREPROCESS_USE_NORMAL_PROCEDURE 1                  // 0: use fast preprocess, 1: use normal preprocess
///////////////////////////////////////////////////
